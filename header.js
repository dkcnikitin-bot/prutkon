...
window.renderTopMenu = () => {
    ...
    const ci = localStorage.getItem('prutkon_login_idx');
    const emp = (window.dbEmployees && window.dbEmployees[ci]) || { name: 'Гость', role: '--' };
        ...
        <ul class="app-menu">
            <li class="menu-item">Система
                <div class="menu-dropdown" style="min-width:240px;">
                    ...
                    <a href="javascript:window.fbPush()" class="dropdown-link" style="color:var(--emerald-neon)"><i class="fa-solid fa-cloud-arrow-up"></i> Облачный бэкап (Firebase)</a>
